...
http GET "${BASE_URL}/users/${USER_ID_PLACEHOLDER}"
echo -e "\n"

echo "### Create Todo ###"
# Expected: { "success": true, "message": "Todo created successfully", "responseObject": { ...new_todo }, "statusCode": 201 }
http POST "${BASE_URL}/todos" text="Learn API Testing" isDone:=false
echo -e "\n"
